...
jsPsych.plugins['cloze-enter'] = (function () {
    ...
    plugin.info = {
        ...
        parameters: {
            ...
            allow_enter_to_continue: {
                type: jsPsych.plugins.parameterType.BOOL,
                pretty_name: 'Allow enter to continue',
                default: true,
                description: 'Whether or not to allow the enter key to continue.'
            }
        }
    };
    ...
    plugin.trial = function (display_element, trial) {
        ...
        var check = function() {
            ...
            if (!trial.check_answers || (trial.check_answers && answers_correct))
            {
                ...
                if (trial.allow_enter_to_continue) {
        ...
        // set cursor focus on first text box
        if (display_element.querySelector('input') !== null ) {
